...
class ProblemSolvingConversation(Conversation):
    ...
    def __init__(
        ...
        self.goals = ["Help the user with problem-solving strategies","Guide the user to identify potential solutions"]
        self.probe_questions = ["Has the user described their problem?", "Has the user identified potential solutions?"]
